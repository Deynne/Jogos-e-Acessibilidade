...
{
    [AddComponentMenu("Scripts/Accessibility Input Module")]
    /// <summary>
    ...
    public class AccessibilityInputModule : PointerInputModule
    {
        ...
        {
            Debug.Log("ShouldIgnoreEventsOnNoFocus");
            switch (SystemInfo.operatingSystemFamily)
            {
                ...
                case OperatingSystemFamily.MacOSX:
                    ...
                    if (UnityEditor.EditorApplication.isRemoteConnected) {
                        Debug.Log("IsRemotConnected");
                        return false;
                    }
#endif
                    Debug.Log("OperatingSystemFamily");
                    return true;
                default:
                    Debug.Log("default");
                    return false;
        ...
        public override void UpdateModule()
        {
            ...
            {
                Debug.Log("UpdateModule - Dentro do if de fogo");
                if (m_InputPointerEvent != null && m_InputPointerEvent.pointerDrag != null && m_InputPointerEvent.dragging)
                {
                    Debug.Log("UpdateModule - Dentro do if de pointerEvent");
        ...
        private void ReleaseMouse(PointerEventData pointerEvent, GameObject currentOverGo)
        {
            ...
            Debug.Log("ReleaseMouse - pointerUpHandler" + pointerUpHandler + " pointerEvent " + pointerEvent + " currentOverGo " + currentOverGo);
        ...
        {
            GameObject currentOverGo = null;// = pointerEvent.pointerCurrentRaycast.gameObject;
